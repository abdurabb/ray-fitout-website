    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 text-white w-full px-8 md:px-12 py-8 md:py-12 lg:py-16 mx-auto">
                <p className="uppercase text-sm sm:text-sm md:text-lg font-extralight opacity-0 fade-up delay-1">
                    Services / Aluminium Systems
                </p>

                <h1 className="uppercase font-light text-lg sm:text-3xl md:text-4xl lg:text-5xl mt-2 opacity-0 fade-up delay-2">
                    Aluminum Systems
                </h1>

                <p className="uppercase text-sm sm:text-sm md:text-lg font-extralight mt-2 opacity-0 fade-up delay-3">
